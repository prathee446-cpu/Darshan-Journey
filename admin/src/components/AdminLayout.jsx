...
import { 
  ...
  Settings, LogOut, Menu, X, Bell, Search, Calendar, User, GitBranch, ChevronRight
} from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const isProfileActive = location.pathname === '/admin/profile' || location.pathname === '/profile';

  // Active page title calculation
  const getPageTitle = () => {
    if (isProfileActive) return 'Administrator Profile & Credentials';
